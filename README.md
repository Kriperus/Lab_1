...
7. функция поиска по значению элемента работает схожим образом с функцией удаления
8. функция поиска по индексу элемента рекурсивно выводит элемент списка
